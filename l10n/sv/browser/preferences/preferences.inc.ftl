...
librewolf-auto-decline-canvas-description = Neka automatiskt kanvasåtkomst till webbplatser utan att uppmana användaren.
librewolf-auto-decline-canvas-warning1 = Det är fortfarande möjligt att tillåta kanvasåtkomst från adressfältet.
