...
librewolf-general-heading2 =
    .label = Brauseri käitumine
librewolf-extension-update-checkbox2 =
    .label = Uuenda lisamoodulid/laiendused automaatselt
    .description = Võimaldab lisamooduleid/laiendusi uuendada ilma kasutaja sekkumiseta. Turvalisuse mõttes on see hea valik.
librewolf-sync-checkbox2 =
    .label = Kasuta teenust Firefox Sync
    .description = Sünkrooni oma andmeid muude brauseritega. Eeldab uuesti käivitamist.
librewolf-autocopy-checkbox2 =
    .label = Kasuta keskmist hiireklõpsu
    .description = Kopeerimiseks valitud teksti saad assetada keskmise hiireklõpsuga.
librewolf-styling-checkbox2 =
    .label = Luba kasutada userChrome.css kohendusvõimalusi
    .description = Lülita see eelistus sisse, kui soovid kasutajaliidest muuta käsitsi lisatud kujunduse abil.
librewolf-network-heading2 =
    .label = Võrgundus
librewolf-ipv6-checkbox2 =
    .label = Lülita IPv6 sisse
    .description = Luba, et { -brand-short-name } loob ühendusi IPv6 abil.
librewolf-privacy-heading2 =
    .label = Privaatsus
librewolf-xorigin-ref-checkbox2 =
    .label = Domeenivälise viitamise reeglid
    .description = Lisa viitamise päisekirje vaid sama domeeni puhul.
librewolf-broken-heading2 =
    .label = Sinu brauseri täpsem tuvastamine
librewolf-webgl-checkbox2 =
    .label = Luba alati WebGL-i kasutamist
    .description = Selle valikuga lubad alati WebGL-i toimida ilma eraldi luba küsimata.
librewolf-webgl-prompt-checkbox2 =
    .label = Peida saidikohane WebGL-i õiguste päring
    .description = Sellega peidad loaküsimispäringu, kui veebisait üritab WebGL-i konteksti kasutada. Klõpsates vastaavt ikooni aadressiribal saad jätkuvalt sama küsimuse avada.
librewolf-rfp-checkbox2 =
    .label = Lülita „ResistFingerprinting“ ehk tuvastusvastased võtted sisse
    .description = Lülitab sisse kõik olemasolevad baruserituvastuse vastased meetmed, kuid see võib põhjustada olukorra, kus mõni veebisait ei toimi korrektselt.
librewolf-letterboxing-checkbox2 =
    .label = Lülita ümbrikpildi vaade sisse
    .description = Ümbrikpildi vaade kasutab üldvaates ääriseid ning sellega vähendatakse sinu veebibrauseri unikaalsust.
...
pane-librewolf-title2 = LibreWolf
    .title = LibreWolf
librewolf-etp =
    .label = Täiustatud jälgimisvastane kaitse
    .description = LibreWolf toetab ja ranges režiimis vaikimisi kasutab täiustatud jälgimisvastast kaitset. Tagades vahekaartide olekute eraldamise, rangete keeluloendite kasutamise ja muud asjalikud privaatsusfunktsionaalsused, on see veebibrauseri üks tähtsamaid seadistusi. Meie ei soovita muude režiimide kasutamist.
librewolf-swap-settings = Muuda seadistuste paigutust
    .title = Muuda seadistuste paigutust
librewolf-mouse-heading2 =
    .label = Hiire käitumine
librewolf-JXL =
    .label = Lülita JXL (JPEG XL) tugi sisse
permissions-canvas2 =
    .label = Kanvaa andmete tuvastamine
