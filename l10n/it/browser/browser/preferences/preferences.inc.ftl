...
librewolf-extension-update-checkbox2 =
    .label = Aggiorna in automatico gli add-ons
    .description = Tieni aggiornate le estensione senza intervenire manualmente.Una buona scelta per la tua sicurezza.
...
librewolf-autocopy-checkbox2 =
    .label = Abilita click centrale per incollare
