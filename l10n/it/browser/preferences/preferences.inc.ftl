...
librewolf-ipv6-warning1 = Invece di bloccare il protocollo IPv6 nel browser, consigliamo di abilitare le estensioni IPv6 della privacy sul tuo Sistema Operativo.
...
librewolf-styling-warning1 = Verifica chi ha creato il tema.
librewolf-xorigin-ref-description = Invia gli indirizzi da cui si visualizzano i contenuti solo se ci troviamo sullo stesso dominio.
librewolf-xorigin-ref-warning1 = Può causare rotture nella pagina. In aggiunta gli indirizzi inviati saranno accorciati.
