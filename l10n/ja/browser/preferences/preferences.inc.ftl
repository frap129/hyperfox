...
librewolf-ocsp-warning1 = これにより、セキュリティーは向上しますが、OCSP サーバーがダウンした際に破損を引き起こす可能性があります。
...
librewolf-xorigin-ref-warning1 = 破損を引き起こす可能性があります。さらに、送信された場合であってもリファラはトリミングされます。
