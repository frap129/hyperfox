...
librewolf-webgl-prompt-checkbox =
    .label = WebGL engedélykérés engedélyezése
librewolf-webgl-prompt-description = Ez engedélykérést hoz létre a WebGL használatakor, ahelyett, hogy közvetlenül megadná a hozzáférést.
