...
librewolf-etp =
    .label = Protection augmentée contre le traçage
    .description = LibreWolf prend en charge - et active par défaut - la protection augmentée contre le traçage en mode Strict. C'est un des paramètres les plus importants du navigateur, car il fourni la séparation des sessions, des listes de blocages strictes et d'autres fonctionnalités pour la vie privée. Nous ne recommandons pas de changer pour d'autres modes.
librewolf-swap-settings = Design des paramètres d'échange
    .title = Design des paramètres d'échange
