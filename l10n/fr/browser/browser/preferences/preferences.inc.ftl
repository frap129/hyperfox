...
librewolf-sync-checkbox2 =
    .label = Activer la synchronisation Firefox
    .description = Synchroniser vos données avec d'autres navigateurs. Nécessite un redémarrage.
librewolf-styling-checkbox2 =
    .label = Autoriser la personnalisation de userChrome.css
    .description = Activez ceci si vous souhaitez personnaliser l'interface utilisateur·rice avec un thème chargé manuellement.
librewolf-network-heading2 =
    .label = Réseau
librewolf-ipv6-checkbox2 =
    .label = Activer l'IPv6
    .description = Autoriser { -brand-short-name } à se connecter en utilisant l'IPv6.
librewolf-privacy-heading2 =
    .label = Vie privée
librewolf-webgl-checkbox2 =
    .label = Toujours autoriser le WebGL
    .description = Ceci autorisera toujours le WebGL sans demander la permission pour.
librewolf-webgl-prompt-checkbox2 =
    .label = Cacher le popup WebGL par site
    .description = Ceci cache le popup qui apparaît quand un site essaie de créer un context WebGL. Vous pouvez toujours manuellement faire apparaître l'invite en cliquant l'icône associée dans la barre de recherche.
librewolf-rfp-checkbox2 =
    .label = Activer ResistFingerprinting
    .description = Active toutes les atténuations de la détection d'empreinte numérique, mais peut perturber le fonctionnement de certains sites web.
librewolf-security-heading2 =
    .label = Sécurité
permissions-webgl2 =
    .label = WebGL
librewolf-general-heading2 =
    .label = Comportement du navigateur
librewolf-autocopy-checkbox2 =
    .label = Activer coller la sélection avec le clic milieu.
    .description = Sélectionner le texte à copier, puis coller la sélection avec le bouton central de la souris.
librewolf-xorigin-ref-checkbox2 =
    .label = Limiter les référents entre origines multiples
    .description = Envoyer un référent uniquement de même origine.
librewolf-broken-heading2 =
    .label = Détection d’empreinte numérique
...
librewolf-rfp-warning =
    .message = Cette fonctionnalité est désactivée car ResistFingerprinting est activé. Cela veut dire que LibreWolf forcera les contenus web à s'afficher dans un thème clair.
permissions-eme2 =
    .label = Contenu protégé par des DRM
pane-librewolf-title2 = LibreWolf
    .title = LibreWolf
librewolf-is-not-default-browser-2 =
    .message = { -brand-short-name } n'est pas défini comme votre navigateur par défaut.
librewolf-is-default-browser-2 =
    .message = { -brand-short-name } est défini comme votre navigateur par défaut.
permissions-canvas2 =
    .label = Extraction de Canvas
librewolf-JXL =
    .label = Activer le support JXL (JPEG XL)
librewolf-mouse-heading2 =
    .label = Comportement de la souris
librewolf-etp =
    .label = Protection améliorée contre le pistage
    .description = LibreWolf prend en charge - et active par défaut - la protection améliorée contre le pistage en mode Strict. C'est un des paramètres les plus importants du navigateur car il fournit la séparation des sessions, des listes de blocages strictes et d'autres fonctionnalités de protection de la vie privée. Nous ne recommandons pas de le changer de mode.
librewolf-swap-settings = Changer l'organisation des paramètres
    .title = Changer l'organisation des paramètres
librewolf-h264 =
    .label = Activer le plugin OpenH264
    .description = Nécessaire pour le partage d'écran sur certains sites web dont Discord.
